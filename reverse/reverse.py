...
class LinkedList:
    ...
    def reverse_list(self):
        ...
        while cur:  # while current node
            # references the next node. Goes to the next node before changing the pointer
            nxt = cur.next_node
            cur.next_node = prev  # flips the pointer to the previous node
